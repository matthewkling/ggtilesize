...
We use `geom_tile_size()` to create a tile-size plot. It requires the x, y, and scale aesthetics, with the latter corresponding to the size of tiles; other aesthetics such as fill, color, or alpha are supported as well. For simplicity we'll just map scale to the sum of x and y here:
